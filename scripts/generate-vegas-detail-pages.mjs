...
const page = (title, eyebrow, intro, facts, details, visual, officialUrl, officialText, backHref, backText, affiliateSlot, includeAffiliate = true, canonicalPath) => `<!doctype html>
<html lang="en"><head>
<!-- Google tag (gtag.js) -->
